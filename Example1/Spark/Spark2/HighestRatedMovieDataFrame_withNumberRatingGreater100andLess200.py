...
if __name__ == "__main__":
    ...
    Filtered_averagesAndCounts = averagesAndCounts.filter("count >=100 AND count<=200")
    # Pull the top 10 results
    topTen = Filtered_averagesAndCounts.orderBy("avg(rating)", ascending=False).take(10)
